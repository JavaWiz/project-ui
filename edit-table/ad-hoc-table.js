    ...
    $.each(ajax_data, function(index, val){
        ...
        table+='<tr class="ad-hoc-row">'+
                    ...
                    '<td>'+
                        ...
                        '<button class="btn edit-button ripple-surface btn_edit"><i class="fa fa-edit"></i></button>'+
                        '<button class="btn delete-button ripple-surface"><i class="fa fa-trash"></i></button>'+
                        '<button class="btn save-button ripple-surface btn_save"><i class="fa fa-check"></i></button>'+
                        '<button class="btn discard-button ripple-surface btn_cancel"><i class="fa fa-ban"></i></button>'+
                    '</td>'+
                '</tr>';
